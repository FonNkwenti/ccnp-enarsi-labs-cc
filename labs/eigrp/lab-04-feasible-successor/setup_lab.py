...
if __name__ == "__main__":
    print("Lab 04 Setup -- Pushing initial-configs (Named Mode EIGRP, degraded R1 fa0/0)")
    print("=" * 70)
    for router in ROUTERS:
        push_config(router)
    print("=" * 70)
    print("[*] Done. Verify adjacencies: show ip eigrp neighbors")
    print("[*] Check topology table: show ip eigrp topology")
    print("[*] Note: R1 fa0/0 has bandwidth 512 / delay 2000 from Lab 03")
