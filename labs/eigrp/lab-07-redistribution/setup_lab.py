...
if __name__ == "__main__":
    devices = [("R1", 5001, "initial-configs/R1.cfg"), ("R2", 5002, "initial-configs/R2.cfg"), ("R3", 5003, "initial-configs/R3.cfg"), ("R4", 5004, "initial-configs/R4.cfg"), ("R5", 5005, "initial-configs/R5.cfg")]
