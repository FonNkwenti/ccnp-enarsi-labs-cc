...
correct IOS context, and updates reference-docs/ios-compatibility.yaml
with pass/fail results.

Usage:
    python3 scripts/verify_ios_commands.py              # test all unknown entries
    python3 scripts/verify_ios_commands.py cmds.yaml   # test specific list
...
YAML_PATH = Path("reference-docs/ios-compatibility.yaml")
