...
class TestLab06Structure(unittest.TestCase):
    def test_files_exist(self):
        base_path = "labs/eigrp/lab-06-filtering-control"
    ...
    def test_scripts_syntax(self):
        scripts = [
            "labs/eigrp/lab-06-filtering-control/scripts/refresh_lab.py",
            "labs/eigrp/lab-06-filtering-control/scripts/fault_inject_1.py",
            "labs/eigrp/lab-06-filtering-control/scripts/fault_inject_2.py",
            "labs/eigrp/lab-06-filtering-control/scripts/fault_inject_3.py"
        ]
