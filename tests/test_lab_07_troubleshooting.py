...
class TestLab07Structure(unittest.TestCase):
    def test_files_exist(self):
        base_path = "labs/eigrp/lab-07-redistribution"
    ...
    def test_scripts_syntax(self):
        scripts = [
            "labs/eigrp/lab-07-redistribution/scripts/refresh_lab.py",
            "labs/eigrp/lab-07-redistribution/scripts/fault_inject_1.py",
            "labs/eigrp/lab-07-redistribution/scripts/fault_inject_2.py",
            "labs/eigrp/lab-07-redistribution/scripts/fault_inject_3.py"
        ]
