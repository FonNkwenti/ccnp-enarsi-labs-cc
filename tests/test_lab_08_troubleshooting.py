...
class TestLab08Structure(unittest.TestCase):
    def test_files_exist(self):
        base_path = "labs/eigrp/lab-08-eigrp-over-vpn"
    ...
    def test_scripts_syntax(self):
        scripts = [
            "labs/eigrp/lab-08-eigrp-over-vpn/scripts/refresh_lab.py",
            "labs/eigrp/lab-08-eigrp-over-vpn/scripts/fault_inject_1.py",
            "labs/eigrp/lab-08-eigrp-over-vpn/scripts/fault_inject_2.py",
            "labs/eigrp/lab-08-eigrp-over-vpn/scripts/fault_inject_3.py"
        ]
