...
class TestLab09Structure(unittest.TestCase):
    def test_files_exist(self):
        base_path = "labs/eigrp/lab-09-dual-stack-migration"
    ...
    def test_scripts_syntax(self):
        scripts = [
            "labs/eigrp/lab-09-dual-stack-migration/scripts/refresh_lab.py",
            "labs/eigrp/lab-09-dual-stack-migration/scripts/fault_inject_1.py",
            "labs/eigrp/lab-09-dual-stack-migration/scripts/fault_inject_2.py",
            "labs/eigrp/lab-09-dual-stack-migration/scripts/fault_inject_3.py"
        ]
